...
ActiveRecord::Schema.define(:version => 20130604211641) do
  ...
  add_index "analysts", ["reset_password_token"], :name => "index_analysts_on_reset_password_token", :unique => true
  ...
  create_table "articles", :force => true do |t|
    ...
    t.boolean  "most_important"
    t.datetime "created_at",     :null => false
    t.datetime "updated_at",     :null => false
    t.integer  "outlet_id"
  end

  add_index "articles", ["analyst_id"], :name => "index_articles_on_analyst_id"
